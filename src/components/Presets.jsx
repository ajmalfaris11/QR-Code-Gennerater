        ...
        {themes.map((theme) => (
            <button
                ...
                className={`px-8 py-2.5 rounded-full text-xs font-bold tracking-widest transition-all duration-300 border ${
                    ...
                    : 'bg-zinc-200/50 dark:bg-zinc-900/40 border-black/5 dark:border-white/5 text-zinc-500 hover:border-black/20 dark:hover:border-white/20 hover:text-zinc-950 dark:hover:text-white'
                }`}
