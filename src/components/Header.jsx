...
const Header = () => (
    <header className="animate-fade-in text-center mb-20 relative">
        ...
        <h1 className="text-6xl md:text-8xl font-black tracking-tightest mb-6 leading-none bg-gradient-to-r from-zinc-950 via-zinc-400 to-zinc-950 dark:from-white dark:via-zinc-500 dark:to-white bg-clip-text text-transparent animate-gradient">
            Lumina QR
        </h1>
